      ...
      <scroll ref="content" class="video-content" :bounce="bounce" :data="recommendList">
        <div>
          <div class="video-player">
            ...
            <iframe class="player-wrapper" :src="playerSrc" scrolling="no" border="0" frameborder="no" framespacing="0"
          ...
          <div class="bottom-tab">
            <div class="switcher-wrapper" v-if="switchList.length">
              <switcher :list="switchList" :indexTab="indexTab" @switchTab="changeContent"
                        displayType="around"></switcher>
            </div>
...
import {getComment, getRecommend, getTags, getVideoInfo} from 'api/video'
import {formatDate, formatNumber} from 'common/js/util'
