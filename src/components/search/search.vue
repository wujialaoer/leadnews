        ...
        <div>
          <div class="search-info" v-show="!query">
            <div class="search-hot">
              ...
              <div class="list">
                <span @click="addQuery(item.keyword)" v-for="(item, index) in hotwords" :key="index"
                      class="hotword-item">{{ item.keyword }}</span>
              </div>
            </div>
...
import {getHotWords, getSearchDefaultWords} from 'api/search'
